...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {var Main = __webpack_require__(2);
	var main = new Main;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var blocks = __webpack_require__(5)(1000);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var Block = __webpack_require__(6).Block;
	var Blocks = __webpack_require__(11).Blocks;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    BlockItem: __webpack_require__(14),
	    BlocksList: __webpack_require__(20),
	    DeletePopup: __webpack_require__(24),
...
/***/ function(module, exports) {
	...
	module.exports = function anonymous(locals, escape, include, rethrow) {
	    ...
	    var __line = 1, __lines = '<div data-id="<%=id %>" class="block <%= stateClass %> <%= selectedClass %>">\n    <div class="block__close">×</div>\n    <div class="block__text"><%= text %></div>\n</div>', __filename = "app/components/BlockItem/BlockItem.ejs";
	    try {
	        var __output = [], __append = __output.push.bind(__output);
	        with (locals || {}) {
	            __append('<div data-id="');
	            __append(escape(id));
	            __append('" class="block ');
	            __append(escape(stateClass));
	            __append(" ");
	            __append(escape(selectedClass));
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {var Backbone = __webpack_require__(3);
	var BlockItem = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(_) {var Backbone = __webpack_require__(3);
...
/***/ function(module, exports) {
	...
	module.exports = function anonymous(locals, escape, include, rethrow) {
	    ...
	    var __line = 1, __lines = '<div class="popup-wrapper">\n    <div class="delete-popup">\n        <div class="delete-popup__text">Удалить блок?</div>\n        <div class="delete-popup__btn-group">\n            <button class="delete-popup__btn delete-popup__btn_delete" id="delete">Удалить</button>\n            <button class="delete-popup__btn delete-popup__btn_cancel" id="cancel">Отмена</button>\n        </div>\n    </div>\n</div>', __filename = "app/components/DeletePopup/DeletePopup.ejs";
	    try {
	        var __output = [], __append = __output.push.bind(__output);
	        with (locals || {}) {
	            __append('<div class="popup-wrapper">\n    <div class="delete-popup">\n        <div class="delete-popup__text">Удалить блок?</div>\n        <div class="delete-popup__btn-group">\n            <button class="delete-popup__btn delete-popup__btn_delete" id="delete">Удалить</button>\n            <button class="delete-popup__btn delete-popup__btn_cancel" id="cancel">Отмена</button>\n        </div>\n    </div>\n</div>');
	            __line = 9;
	        }
	        return __output.join("");
	    } catch (e) {
...
/***/ function(module, exports) {
	...
	module.exports = function anonymous(locals, escape, include, rethrow) {
	    ...
	    var __line = 1, __lines = '<div class="panel">\n        <div class="panel__item"><%= blockCount %></div>\n        <div class="panel__item panel__item_selected"><%= selectedCount %></div>\n        <div class="panel__item panel__item_red"><%= redCount %></div>\n        <div class="panel__item panel__item_green"><%= greenCount %></div>\n        <div id="add-block" class="panel__item panel__item_add">+</div>\n</div>', __filename = "app/components/Panel/Panel.ejs";
	    try {
	        var __output = [], __append = __output.push.bind(__output);
	        with (locals || {}) {
	            __append('<div class="panel">\n        <div class="panel__item">');
	            __line = 2;
	            __append(escape(blockCount));
	            __append('</div>\n        <div class="panel__item panel__item_selected">');
	            __line = 3;
	            __append(escape(selectedCount));
	            __append('</div>\n        <div class="panel__item panel__item_red">');
	            __line = 4;
	            __append(escape(redCount));
	            __append('</div>\n        <div class="panel__item panel__item_green">');
	            __line = 5;
	            __append(escape(greenCount));
	            __append('</div>\n        <div id="add-block" class="panel__item panel__item_add">+</div>\n</div>');
	            __line = 7;
	        }
	        return __output.join("");
